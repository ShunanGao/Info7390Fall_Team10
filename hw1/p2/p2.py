...
accessKey = input("Please input the S3 Access accessKey:")
secretAccessKey = input("Please input the S3 secretAccessKey:")
year = input("Please input year (between 2003 and 2017):")
...
try:
    # for i in range(0, len(month_quarter) * 3):
    for i in range(0, 1):
...
accessKey = 'AKIAIZFB4WGZUK5U6B3Q'
secretAccessKey = 'EYLJlmLwo370iHvTNA7SnoI5S3fl8rIMtKU1yILP'
...
try:
    ...
    bucket_name = 'PartTwo'.lower() + str(st).replace(" ", "").replace("-", "").replace(":", "").replace(".", "")
